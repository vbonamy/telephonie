...
var telephonieApp = angular.module('telephonieApp', ['http-auth-interceptor', 'tmh.dynamicLocale',
    'ngResource', 'ngRoute', 'ngCookies', 'telephonieAppUtils', 'pascalprecht.translate', 'truncate']);
